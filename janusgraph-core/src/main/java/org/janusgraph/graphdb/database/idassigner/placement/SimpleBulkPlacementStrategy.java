...
/**
 * A id placement strategy that assigns all vertices created in a transaction to
 * the same partition id. The partition id is selected randomly from a set of
 * partition ids that are retrieved upon initialization.
 *
...
public class SimpleBulkPlacementStrategy implements IDPlacementStrategy {
	...
	public static final ConfigOption<Integer> CONCURRENT_PARTITIONS = new ConfigOption<Integer>(
	 ...
	 * 
	 * @param vertex
	 *            ignored for this simple placement strategy
	 */
	@Override
